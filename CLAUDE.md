...
**助成金の数値・要件を書くときは暗記で書かない。**厚労省の当年度パンフレット・リーフレットのPDFを
実際に開いて確認し、出典URLと確認日時を残すこと（`sharoushi` スキル参照）。
2026-08-01の監修で、業務改善助成金の助成率の閾値・判定時点、キャリアアップ助成金の加算の単位、
人材開発支援助成金の計画届の提出期限に誤りが見つかっている。
