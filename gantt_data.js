...
window.KOBAN_GANTT = {
  ...
  tasks: [
    ...
    { id: 'j11', scheme: 'jinzai', phase: '準備', task: '電子申請するならGビズIDを取得する', owner: '事業主', days: 14, anchor: 'training_start', offset: -60, when: '訓練開始日の60日前', dep: [], warn: '発行までに日数がかかります。申請直前に始めると間に合いません', source: 'https://www.mhlw.go.jp/content/11800000/001687559.pdf', checked: '2026-08-02 13:05 JST' },
