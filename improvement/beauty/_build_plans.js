...
// brown は5つ目(自己資金、2026-08-16)。
// 省力化=green / 業務改善・持続化=gold / AI導入=navy / 自己資金=brown で、計画書の見出し帯とバッジに使う。
const C = { ink:"#26221e", sub:"#6f675e", line:"#d9d2c8", accent:"#8a5a2b", green:"#3e6b4f", gold:"#b98a2f", red:"#a4453c", navy:"#2b5f8a", brown:"#7a6a52", bg:"#faf8f5" };
...
// ---- 10案データ ----
// scheme: 省力化 / AI導入 / 持続化 / 業務改善 / 自己資金
// 2026-08-16、診断士の指摘を受け「補助金の上限に投資額を合わせる」逆算をやめ、
// 経営上必要な投資規模を先に決めてから合う制度を当てる順序で全10案を再設計した。
// no2・no10はどの制度にも無理なく当てはまらないため自己資金推奨とした。
// inv: 投資総額(万円), subsidy: 補助上限%, self: 自己/借入負担, saveH: 省力化(h/月), saveY: 年間削減額(万円), roi: 回収年
const PLANS = [
{ no:1, key:"01-ai-multilingual-blog", proto:"01-ai-multilingual-blog.html", scheme:"持続化",
  title:"AI多言語ブログ自動投稿による情報発信の省力化とインバウンド販路開拓",
  sub:"AIが毎日10言語のブログ記事を自動生成・SEO/MEO最適化し、記事作成の負担ゼロ化と外国人集客を同時に実現する",
  inv:110, invItems:[["AI記事生成・多言語CMSライセンス(3年)","50"],["多言語予約ページ連携開発","30"],["初期構築・SEO/MEO設定","20"],["スタッフ操作研修","10"]],
  saveH:28, saveY:95, roi:0.8, wageUp:70,
  problemLead:"ブログやSNSでの情報発信は集客に不可欠だが、記事作成は1本あたり60〜90分を要し、多言語対応は外注で1言語1万円超。人手で毎日・多言語の発信を続けることは物理的に不可能で、発信が途切れると検索流入も落ちる。",
  kpis:[{label:"記事作成時間",before:28,after:3},{label:"月間投稿数",before:4,after:14},{label:"検索流入(百PV)",before:12,after:36},{label:"外国人予約",before:3,after:16}],
  flow:["予約・トレンド\nデータを取得","AIが日本語\n記事を生成","10言語へAI\nローカライズ","SEO/MEO\n構造化を付与","CMS・GBPへ\n自動投稿"],
  effectRows:[["月間ブログ投稿数","4本","14本","+250%"],["記事1本あたり作業","75分","8分","▲89%"],["月間検索流入","1,200PV","3,620PV","+202%"],["外国人客の月間予約","3件","16件","+433%"],["情報発信の月間工数","30時間","3時間","▲27h/月"]],
...
{ no:2, key:"02-ai-phone-reservation", proto:"02-ai-phone-reservation.html", scheme:"自己資金",
  title:"AI電話予約自動応対システム導入による予約受付業務の省力化",
  sub:"施術中の電話対応をAI音声が24時間自動化し、スタッフの作業中断ゼロと営業時間外予約の獲得を両立する",
  inv:100, invItems:[["クラウドAI音声応対システム(3年)","45"],["予約/顧客システム連携開発","25"],["初期設定・シナリオ構築","20"],["導入研修・運用整備","10"]],
  saveH:32, saveY:150, roi:0.8, wageUp:0,
  problemLead:"施術中の電話は美容室最大の作業中断要因。1件平均4.2分の対応がスタイリストの手を止め、施術品質と回転率を下げる。営業時間外や施術集中時の不応答による予約取りこぼしは、機会損失として月間40万円超と試算される。",
  kpis:[{label:"応対工数(h/月)",before:32,after:3},{label:"取りこぼし予約",before:28,after:4},{label:"時間外予約獲得",before:0,after:22},{label:"AI完結率(%)",before:0,after:85}],
  flow:["着信をAIが\n24時間受付","音声認識で\n意図を理解","空き枠を\n自動照会","顧客DB照合\n・予約確定","カルテへ通話\n記録を自動転記"],
  effectRows:[["電話応対の月間工数","32時間","3時間","▲29h/月"],["施術中の作業中断","1日平均8回","1回","▲88%"],["営業時間外の予約獲得","0件","22件/月","新規獲得"],["予約取りこぼし","月28件","月4件","▲86%"],["取りこぼし由来の機会損失","約38.6万円/月","約6万円/月","▲32.6万円"]],
...
{ no:3, key:"03-ai-counseling-karte", proto:"03-ai-counseling-karte.html", scheme:"AI導入",
  title:"AIカウンセリング・施術提案カルテによる接客品質の標準化と記録業務の省力化",
  sub:"顧客写真をAIが解析して施術提案とカルテを自動生成し、提案品質の均一化と閉店後のカルテ残業ゼロを実現する",
  inv:250, invItems:[["AI画像解析・提案エンジン(3年)","120"],["電子カルテ・POS連携開発","60"],["撮影機材(マイクロスコープ等)","35"],["導入研修・スタッフ習熟支援","35"]],
  saveH:24, saveY:168, roi:0.9, wageUp:0,
  ...
  kpis:[{label:"カルテ記入(h/月)",before:24,after:2},{label:"新人の提案採用率",before:38,after:68},{label:"客単価(千円)",before:96,after:109},{label:"指名リピート率",before:54,after:66}],
  flow:["顧客写真を\nAI解析","髪質・肌・顔型\nを数値診断","禁忌・アレル\nギーを自動照合","根拠付き施術\n提案を生成","確定内容を\nカルテ自動記録"],
  effectRows:[["カルテ記入の月間工数","24時間/人","2時間/人","▲22h/月"],["提案品質のばらつき","経験依存","AI標準化","均一化"],["新人スタイリストの提案採用率","38%","68%","+79%"],["平均客単価","9,600円","10,900円","+13.5%"],["アレルギー等の施術事故","年2件","0件","▲100%"]],
  distinct:"接客の属人化という業界積年の課題に対し、AIが診断根拠を可視化して提案する点が差別化。新人でもベテラン級の提案が可能になり、育成期間を短縮。カルテ自動化と提案高度化を1システムで同時に達成する。写真解析・カルテ記録・施術提案の複数プロセスにまたがるITツールである。",
...
{ no:4, key:"04-ai-meo-review", proto:"04-ai-meo-review.html", scheme:"持続化",
  title:"口コミAI自動返信とMEO最適化による集客業務の省力化と新規顧客獲得",
  sub:"Google口コミへのAI自動返信とビジネスプロフィール運用を自動化し、地図検索順位と新規予約を継続的に高める",
  inv:70, invItems:[["口コミAI返信・MEO運用ツール(3年)","35"],["GBP・予約システム連携","15"],["初期設定・分析基盤構築","10"],["運用研修","10"]],
  saveH:10, saveY:70, roi:0.4, wageUp:70,
  problemLead:"地図検索(MEO)は新規来店の最大の導線だが、口コミへの返信・写真投稿・情報更新には月12時間を要し、多忙な現場では後回しになりがち。返信率の低下や情報の陳腐化は検索順位を下げ、新規客の減少に直結する。",
  kpis:[{label:"MEO順位",before:14,after:5},{label:"口コミ返信率(%)",before:40,after:95},{label:"星評価",before:42,after:47},{label:"地図経由予約",before:13,after:27}],
  flow:["新着口コミ・\n検索動向を取得","AIが個別返信\n下書きを生成","(ネガは店長承認)\n自動投稿","GBP情報・写真\nを自動更新","順位・評判を\n分析しレポート"],
  effectRows:[["MEO運用の月間工数","12時間","2時間","▲10h/月"],["「地域名+美容室」検索順位","14位","5位","▲9位"],["口コミ返信率","40%","95%","+138%"],["平均星評価","4.2","4.7","+0.5"],["地図経由の新規予約","13件/月","27件/月","+108%"]],
  distinct:"返信・投稿・分析・順位追跡を1つで自動化し、ネガティブ口コミのみ人的承認を挟む安全設計が差別化。効果が順位・件数で定量的に測れるため、新規顧客獲得(販路開拓)の成果を数値で説明しやすい。",
...
{ no:5, key:"05-ai-short-video", proto:"05-ai-short-video.html", scheme:"持続化",
  title:"施術動画ショートAI自動編集による動画制作の省力化とSNS集客強化",
  sub:"撮影素材からAIがショート動画を自動編集・多媒体投稿し、動画編集の負担ゼロ化と若年層集客を実現する",
  inv:120, invItems:[["AI動画編集・自動投稿システム(3年)","55"],["撮影機材・スタジオ照明","34"],["初期設定・テンプレ構築","21"],["運用研修","10"]],
  saveH:14, saveY:85, roi:1.0, wageUp:70,
  problemLead:"ショート動画は若年層集客に極めて有効だが、編集は1本2〜3時間の重負荷業務。専任者を置けない小規模店では継続的な投稿ができず、SNS集客の機会を逃している。撮影しても編集が追いつかず素材が死蔵される。",
  kpis:[{label:"動画編集(h/月)",before:14,after:1},{label:"月間投稿本数",before:2,after:9},{label:"リール経由予約",before:1,after:6},{label:"新規客の20代比率",before:18,after:28}],
  flow:["施術風景を\n撮影(そのまま)","AIがベスト\nシーンを抽出","テロップ・BGM\nを自動付与","多言語キャプ\nション生成","4媒体へ最適\nサイズで投稿"],
  effectRows:[["動画編集の月間工数","14時間","1時間","▲13h/月"],["月間ショート動画投稿","2本","9本","+350%"],["リール経由の新規予約","1件/月","6件/月","+500%"],["新規客の20代以下比率","18%","28%","+10pt"],["1本あたり編集コスト","約6,000円","約1,500円","▲75%"]],
...
{ no:6, key:"06-ai-auto-order", proto:"06-ai-auto-order.html", scheme:"AI導入",
  title:"薬剤・材料AI自動発注システムによる在庫管理業務の省力化",
  sub:"POS・カルテ連動で使用量をAIが予測し発注・棚卸を自動化、作業時間削減と在庫金額・廃棄ロスの圧縮を実現する",
  inv:230, invItems:[["AI需要予測・自動発注システム(3年)","115"],["POS・カルテ・在庫連携開発","60"],["棚卸用画像認識・機器","33"],["導入研修","22"]],
  saveH:17, saveY:138, roi:1.0, wageUp:0,
  problemLead:"薬剤・材料の発注と棚卸は月18時間のノンコア業務。勘に頼った発注は過剰在庫による資金の固定化(約32万円)と、使用期限切れの廃棄ロスを生む。一方で欠品は施術不能という致命的な機会損失に直結する。",
  kpis:[{label:"発注・棚卸(h/月)",before:17,after:2},{label:"在庫金額指数",before:100,after:79},{label:"廃棄ロス(件/月)",before:6,after:0},{label:"欠品による施術不可",before:4,after:0}],
  flow:["予約メニューと\n調合レシピ取得","AIが使用量を\n予測","適正在庫と\n差分を算出","最安ルートで\n発注書を生成","入荷を在庫へ\n自動反映"],
  effectRows:[["発注・棚卸の月間工数","17時間","2時間","▲15h/月"],["在庫金額","基準100","79","▲21%"],["使用期限切れ廃棄","月6件","0件","▲100%"],["欠品による施術不可","月4件","0件","▲100%"],["仕入コスト(相見積り効果)","基準","▲3.8%","コスト減"]],
  distinct:"単純な発注点管理ではなく、予約メニューと調合レシピから実使用量を予測し、天候(梅雨の縮毛矯正需要増など)まで学習する点が差別化。複数ディーラーの価格を比較し最安・送料最適の発注書を自動生成する。POS・カルテ・在庫を横断するシステムである。",
...
{ no:7, key:"07-ai-shift-romu", proto:"07-ai-shift-romu.html", scheme:"業務改善",
  title:"AIシフト自動作成・労務アラートシステムによる労務管理業務の省力化",
  sub:"予約需要と法令要件を加味したシフトをAIが自動作成し、作成時間の大幅短縮と労務コンプライアンスの向上を両立する",
  inv:70, invItems:[["AIシフト最適化・労務管理システム(3年)","30"],["勤怠・予約システム連携開発","15"],["就業規則ロジック実装(社労士監修)","20"],["導入研修","5"]],
  saveH:14, saveY:75, roi:0.3, wageUp:70,
  problemLead:"シフト作成は店長業務の最大負荷の一つで、希望休・指名確保・技術配置・法令を同時に満たす調整に月20時間超。手作業では連勤超過や残業過多、有給5日義務の未達といった労務リスクを見落としやすく、労使トラブルの温床となる。",
  kpis:[{label:"シフト作成(h/月)",before:14,after:2},{label:"労務違反の見落とし",before:4,after:0},{label:"急な欠員の充足率(%)",before:60,after:90},{label:"残業時間(h/月)",before:41,after:33}],
  flow:["予約需要を\nAIが予測","希望休・指名\nを自動集約","技術レベルで\n人員を最適配置","労働時間・休憩\nを法令チェック","違反を自動修正\nし全員へ配信"],
  effectRows:[["シフト作成の月間工数","14時間","2時間","▲12h/月"],["連勤・残業等の労務違反見落とし","月4件","0件","▲100%"],["急な欠員のカバー率","60%","90%","+30pt"],["スタッフ1人月間残業","41時間","33時間","▲8h"],["有給5日義務の未達","年2件","0件","▲100%"]],
...
{ no:8, key:"08-ai-training-video", proto:"08-ai-training-video.html", scheme:"業務改善",
  ...
  inv:140, invItems:[["AI動画教材生成・学習管理システム(3年)","60"],["撮影機材・編集基盤","34"],["初期教材ライブラリ構築","26"],["運用研修","20"]],
  saveH:22, saveY:110, roi:0.4, wageUp:70,
  ...
  kpis:[{label:"指導時間(h/週)",before:9,after:4},{label:"デビュー期間(年)",before:32,after:26},{label:"教材ライブラリ(本)",before:0,after:40},{label:"新人習熟度(%)",before:45,after:70}],
  flow:["熟練者の施術\n動画を撮影","AIがシーン\n分割・章立て","字幕・重要\n点を自動抽出","確認クイズを\n自動生成","習熟度を管理\n・弱点を提示"],
  effectRows:[["マンツーマン指導時間","週9時間","週4時間","▲5h/週"],["スタイリストデビュー期間","3.2年","2.6年","▲0.6年"],["教材ライブラリ","0本","40本(自動)","資産化"],["新人の技術習熟度","45%","70%","+56%"],["退職時の技術ノウハウ喪失","都度発生","アーカイブ済","損失防止"]],
...
{ no:9, key:"09-ai-accounting", proto:"09-ai-accounting.html", scheme:"AI導入",
  title:"レジ締め・記帳AI自動化システムによる経理・バックオフィス業務の省力化",
  sub:"POSとキャッシュレス明細をAIが自動突合してレジ締め・仕訳・日報を完結し、日次事務の削減と月次決算の早期化を実現する",
  inv:120, invItems:[["AIレジ締め・自動記帳システム(3年)","50"],["POS・キャッシュレス・会計連携開発","40"],["初期設定・仕訳ルール構築","20"],["導入研修","10"]],
  saveH:18, saveY:105, roi:0.7, wageUp:0,
  problemLead:"レジ締めと記帳は毎日必ず発生する業務で、閉店後に毎日25〜35分、月20時間を要する。複数のキャッシュレス決済の突合や現金差異の調査は煩雑で、経理入力の負担と月次試算表の遅れが、タイムリーな経営判断を妨げている。",
  kpis:[{label:"事務時間(h/月)",before:18,after:2},{label:"レジ締め(分/日)",before:28,after:4},{label:"月次試算完成(日)",before:10,after:3},{label:"記帳ミス(件/月)",before:7,after:0}],
  flow:["POS・決済明細\nを自動取得","AIが自動\n突合・照合","差異を検知し\n原因を特定","仕訳を生成し\n会計ソフト連携","日報・月次\nを自動作成"],
  effectRows:[["経理・レジ締めの月間工数","18時間","2時間","▲16h/月"],["1日のレジ締め時間","28分","4分","▲24分/日"],["月次試算表の完成","翌月10日","翌月3日","7日早期化"],["記帳ミス","月7件","0件","▲100%"],["現金差異の原因特定","手作業で困難","自動特定","即時化"]],
  distinct:"POSと複数キャッシュレスの自動突合に加え、現金差異をレジ映像のタイムスタンプ照合で原因特定する点が差別化。仕訳・日報・月次サマリーを自動生成し税理士へ共有、月次決算を早期化して経営判断を加速する。決済・在庫管理・会計連携にまたがる複数プロセスのITツールである。",
...
{ no:10, key:"10-ai-repeat-follow", proto:"10-ai-repeat-follow.html", scheme:"自己資金",
  title:"リピート予測・AI再来店フォローシステムによる顧客維持業務の省力化とLTV向上",
  sub:"来店周期をAIが学習し離反前に最適タイミングで自動フォローすることで、失客防止とフォロー業務の自動化を両立する",
  inv:80, invItems:[["AIリピート予測・自動配信システム(3年)","40"],["顧客・予約・LINE連携開発","20"],["初期設定・セグメント構築","12"],["運用研修","8"]],
  saveH:11, saveY:85, roi:1.1, wageUp:0,
  ...
  kpis:[{label:"再来店率(%)",before:54,after:63},{label:"失客率(%)",before:32,after:22},{label:"フォロー工数(h/月)",before:11,after:1},{label:"平均LTV指数",before:100,after:114}],
  flow:["来店履歴・周期\nをAIが学習","離反リスクを\nスコア化","最適タイミング\nを判定","個別メッセージ\nを自動生成","LINE/メールで\n自動配信"],
  effectRows:[["フォロー業務の月間工数","11時間","1時間","▲10h/月"],["90日再来店率","54%","63%","+9pt"],["月間失客率","32%","22%","▲10pt"],["休眠客の掘り起こし","ほぼ不可","18名/月","新規復帰"],["平均顧客生涯価値(LTV)","8.9万円","10.1万円","+14%"]],
...
function schemeInfo(scheme, p) {
  ...
  if (scheme === "持続化") {
    ...
    //
    // 投資額(inv)が上限50万円の2/3ライン(=75万円)を超えると、制度上の補助率2/3のまま
    // 頭打ちになり実質の補助率は下がる(こじつけではなく上限による自然な結果)。
    // rate の先頭ラベルにこの実質値を出さないと「補助金(2/3)」と書いて実際は半分以下、
    // という食い違いが再発する（2026-08-16、省力化で一度直した食い違いと同型）。
    const subAmt = Math.min(50, Math.round(p.inv * 2 / 3));
    const actualPct = Math.round(subAmt / p.inv * 1000) / 10;
    const capped = subAmt < Math.round(p.inv * 2 / 3);
    const rate = capped
      ? `${actualPct}%(上限到達のため実質。制度上は2/3。賃金引上げ特例のうち赤字事業者は3/4)`
  ...
  if (scheme === "自己資金") {
    // 補助金を使わず自己資金・借入で実施する案。無理な制度当てはめ(こじつけ)を避け、
    // 正直なモデルケースとして提示する（2026-08-16、診断士の判定を受けて新設）。
    return {
      badge: "自己資金による実施(補助金なし)", color: C.brown,
      rate: "0%(補助金を活用しない)",
      subAmt: 0, self: p.inv,
      cap: "制度上限なし(自己資金・リース・低利融資で実施)",
      wage: "【任意】補助金の賃上げ要件は生じないが、生産性向上の成果を賃上げ原資へ充当する方針は"
        + "他案と同様に維持し、事業場内最低賃金の引上げは任意目標として記載する。",
      audit: "補助金の交付審査は発生しない。金融機関からの融資を想定する場合は、"
        + "事業計画の実現可能性・投資回収の妥当性が融資審査の実質的な評価観点となる。"
        + "交付決定待ちが不要なため、意思決定後ただちに着手できる利点がある。",
    };
  }
...
function buildPlan(p) {
    ...
    <div class="split">
      <div class="half">
        ...
        <table class="data">
          ...
          ${s.subAmt > 0 ? `<tr><td>補助金(${s.rate.split("(")[0]})</td><td class="num" style="color:${s.color}">▲${s.subAmt}万円</td></tr>` : ""}
      ...
      <div class="half">
        ...
        <div class="callout small">${s.subAmt > 0
          ? "補助金は精算払いのため、つなぎ資金を金融機関借入で確保。返済は本事業の収益改善キャッシュフローで賄う計画とし、資金繰りの安全性を確保する。"
          : "補助金を活用しないため交付決定を待たず着手できる。自己資金と金融機関借入で初期投資を賄い、返済は本事業の収益改善キャッシュフローで賄う計画とする。"}</div>
      </div>
    </div>
  ...
  const P10 = `
    <h3>${p.scheme === "自己資金" ? "実施要件チェックリスト" : "補助要件チェックリスト"}</h3>
    <table class="data wide">
      ...
      <tr><td>${p.scheme === "業務改善" ? "事業場内最低賃金の引上げ" : p.scheme === "自己資金" ? "賃上げ計画(任意目標)" : "賃上げ計画(特例・加点の活用時)"}</td><td>+${wageUpOf(p)}円の引上げを計画</td><td class="ok">✔</td></tr>
      ${p.scheme === "自己資金"
    ...
    <h3>${p.scheme === "自己資金" ? "補助金活用の可能性メモ" : "他制度への転用メモ"}</h3>
    <div class="callout">
      <b>本計画のメイン: ${s.badge}</b><br>
      ${{
        "省力化": `本事業は省力化(生産性向上)効果が明確なため<b>省力化投資補助金(一般型)</b>を主軸とした。一方、賃上げを主目的に据え直せば<b>業務改善助成金</b>への転用も可能。その場合は事業場内最低賃金の引上げ額(50円以上)を軸に、対象経費を生産性向上に資する設備投資へ組み替える。`,
        "業務改善": `本事業は賃上げと業務改善の親和性が高いため<b>業務改善助成金</b>を主軸とした。一方、投資規模を拡大し省力化効果を前面に出せば<b>省力化投資補助金(一般型)</b>への転用も可能。その場合は補助上限が大きく、大幅賃上げ特例で補助率2/3を狙える。`,
    ...
    <table class="kv" style="margin-top:8px">
      <tr><td>参照した最新公募情報(2026年時点)</td><td>省力化投資補助金(一般型)第6・7回公募 / デジタル化・AI導入補助金2026(通常枠) / 小規模事業者持続化補助金(第20回) / 業務改善助成金 令和8年度</td></tr>
    </table>`;
