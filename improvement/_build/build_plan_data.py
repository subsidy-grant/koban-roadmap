...
SCHEMES = {
    ...
    "jizoku": dict(
        ...
        rateText="2/3以内", capText="50万円（通常枠。賃金引上げ枠は200万円）",
        flowSteps=[["準備", "商工会議所へ\n相談"], ["計画作成", "経営計画書\n補助事業計画書"],
                   ["申請", "様式提出\n（電子申請）"], ["採択・実施", "交付決定後に\n発注・実施"],
                   ["報告・受給", "実績報告\n→入金"]],
        note="申請には地域の商工会議所・商工会の支援（様式4の発行）が必要。従業員5人以下（宿泊・娯楽業を除く商業・サービス業）等の小規模事業者が対象。"),
    "shoryokuka": dict(
        label="中小企業省力化投資補助金（カタログ注文型）", rate=0.5, cap=500,
        rateText="1/2（小規模事業者は2/3）", capText="500万円（従業員5人以下・カタログ注文型。特例750万円）",
        flowSteps=[["準備", "GビズID取得\nカタログ確認"], ["製品選定", "登録製品・\n販売事業者を選ぶ"],
                   ["申請", "販売事業者と\n共同申請"], ["交付決定", "決定後に\n発注・設置"],
                   ["報告・受給", "実績報告\n→入金"]],
    ...
    "shoryokuka_ippan": dict(
        ...
        rateText="1/2（小規模事業者・再生事業者は2/3）", capText="750万円（従業員5人以下・一般型。規模により最大8,000万円）",
        flowSteps=[["準備", "GビズID取得\n事業計画の策定"], ["申請", "電子申請\n（jGrants）"],
                   ["審査・採択", "外部有識者\nによる審査"], ["交付決定", "決定後に\n発注・設置"],
                   ["報告・受給", "実績報告\n→入金"]],
    ...
    "kaizen": dict(
        ...
        rateText="3/4（賃上げ後の事業場内最低賃金1,000円未満は4/5）",
        capText="450万円（90円コース・引上げ人数による。特例600万円）",
    ...
    "monodukuri": dict(
        label="新事業進出・ものづくり商業サービス補助金", rate=0.5, cap=750,
        rateText="1/2（特例2/3）", capText="革新的新製品・サービス枠 750万〜3,500万円（従業員規模により変動）",
        flowSteps=[["準備", "GビズID取得\n事業計画の策定"], ["申請", "電子申請\n（jGrants）"],
                   ["審査・採択", "書面・\n事業計画審査"], ["交付決定", "決定後に\n発注・導入"],
                   ["報告・受給", "実績報告\n→入金"]],
