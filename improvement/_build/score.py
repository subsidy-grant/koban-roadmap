...
IDEA_BOARDS = {
    "food": "飲食業×AI 1000案のPDCAファネル・一覧を見る（飲食業版）↗",
    # 以下4業種の改善計画10選は準備中。ボードのTOP10は「採択候補」であり
    # 採択済みではない(ボード冒頭・フッターにも明記している)
    "lodging": "宿泊業×AI 1000案の評価ボードを見る（TOP10は採択候補）↗",
    "manufacturing": "製造業×AI 1000案の評価ボードを見る（TOP10は採択候補）↗",
    "realestate": "不動産業×AI 1000案の評価ボードを見る（TOP10は採択候補）↗",
    "education": "教育業×AI 1000案の評価ボードを見る（TOP10は採択候補）↗",
}
