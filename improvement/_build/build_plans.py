...
CSS_TMPL = """
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .page{width:210mm;min-height:280mm;background:#fff;margin:14px auto;padding:14mm 13mm 10mm;position:relative;display:flex;flex-direction:column;box-shadow:0 2px 12px #0002}
